...
export default function Projects() {
  return (
    <>
      <h3 className="text-4xl font-sono py-5 text-purple-400">My Projects</h3>
          {/* Projects listed by cards */}
          <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-5">

          <div className="card image-full transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-150 ...">
              <figure>
              ...
              <div className="card-body">
                ...
                <p className="font-bold font-sono text-white">A clone of Google Keep written by me.</p>
                <ul className="text-white font-sono mb-3">Function:
                  <li>Register, login</li>
                  <li>Take notes, delete unused notes</li>
                </ul>
                <a href="https://github.com/th0ng/Keepaki" target="_blank" className="text-yellow-600" rel="noreferrer">Visit Git repos.</a>
                <a href="#" target="_blank" className="text-yellow-600">Web App released soon.</a>
          ...
          <div className="card bg-base-100 shadow-xl image-full transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-150 ...">
              <figure>
              ...
              <div className="card-body">
                ...
                <p className="font-bold font-sono text-white">A clone of Spotify written by me.</p>
                <ul className="text-white font-sono mb-3">Function:
                ...
                <a href="https://github.com/th0ng/Spotaki" target="_blank" className="text-green-500" rel="noreferrer">Visit Git repos.</a>
                <a href="https://spotaki.netlify.app" target="_blank" className="text-green-500" rel="noreferrer">Visit Web App</a>
                <div className="card-actions justify-end">
                <div className="badge badge-primary">Reactjs</div>
          ...
          <div className="card bg-base-100 shadow-xl image-full transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-150 ...">
              ...
              <div className="card-body">
                <h2 className="card-title font-sono text-purple-400">Ecommerce</h2>
                <p className="font-bold font-sono text-white">An Ecommerce web application.</p>
                <ul className="text-white font-sono mb-3">Function:
